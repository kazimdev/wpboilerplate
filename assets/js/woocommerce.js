(function ($) {
  $(document).ready(function () {
    ...
    $(document).on("click", ".search-ui-wrapper .close", function(e){
      $(".search-ui-wrapper").hide();
    });
    /**
     * ------------------------------------
     * Get Delivery Info
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (position) => {
          ...
          $.ajax({
            ...
            data: {
              action: "wpboilerplate_get_shipping_info",
              latitude: latitude,
              longitude: longitude,
            },
            success: function (res) {
              if (res.data.free_shipping) {
                ...
                $(".wpboilerplate-product-info .delivery-info").append(
                  freeShippingBtn
                );
              }
            },
    ...
    var buyNowButtonUrl = $(".wpboilerplate-add-to-cart a.buy-now").attr("href");
    ...
    function setProductQuantity(quantity) {
      ...
      $(".wpboilerplate-add-to-cart a.buy-now").attr("href", urlWithQuantity);
    }
  });

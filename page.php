...
$page_layout_meta = WPBoilerplate_Group_Fields_Value::page_layout('wpboilerplate');
$page_container_meta = WPBoilerplate_Group_Fields_Value::page_container('wpboilerplate', 'container_options');
...
?>
	<div id="primary" class="content-area wpboilerplate-page-content-area <?php echo esc_attr($full_width_class); ?>">

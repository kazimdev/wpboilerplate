...
if (!class_exists('WPBoilerplate_Init')) {

    class WPBoilerplate_Init
    {
        /**
         * $instance
         * @since 1.0.0
        ...
        public function theme_setup()
        {
             ...
             */
            load_theme_textdomain('wpboilerplate', get_template_directory() . '/languages');
            ...
            register_nav_menus(array(
                'main-menu' => esc_html__('Primary Menu', 'wpboilerplate'),
                'main-menu-02' => esc_html__('Primary Menu Two', 'wpboilerplate'),
            ));
            ...
            $GLOBALS['content_width'] = apply_filters('wpboilerplate_content_width', 740);

            //add image sizes
            add_image_size('wpboilerplate_classic', 750, 400, true);
            add_image_size('wpboilerplate_grid', 370, 270, true);
            add_image_size('wpboilerplate_medium', 550, 380, true);
        ...
        public function load_theme_css()
        {
            ...
            wp_enqueue_style('wpboilerplate-style', get_stylesheet_uri());

            if (wpboilerplate()->is_wpboilerplate_core_active()) {
                if (file_exists(WPBOILERPLATE_DYNAMIC_STYLESHEETS . '/theme-inline-css-style.php')) {
                    require_once WPBOILERPLATE_DYNAMIC_STYLESHEETS . '/theme-inline-css-style.php';
                    require_once WPBOILERPLATE_DYNAMIC_STYLESHEETS . '/theme-option-css-style.php';
                    wp_add_inline_style('wpboilerplate-style', wpboilerplate()->minify_css_lines($GLOBALS['wpboilerplate_inline_css']));
                    wp_add_inline_style('wpboilerplate-style', wpboilerplate()->minify_css_lines($GLOBALS['theme_customize_css']));
                }
            }
        }
    ...
    if (class_exists('WPBoilerplate_Init')) {
        WPBoilerplate_Init::getInstance();
    }
}

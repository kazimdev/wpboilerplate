...
class WPBoilerplate_Breadcrumb
{
	/**
	 * Array of bread WPBoilerplate_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct(array $options = [])
	{
		...
		$this->defaults['home'] = esc_html__('Home', 'wpboilerplate');
		$this->defaults['blog'] = esc_html__('Blog', 'wpboilerplate');
	...
	public function theBreadcrumbs()
	{
		...
		foreach ($breadcrumbs as $crumb) {
			...
			if ($crumb['url']) {
				...
				$html .= sprintf('<span>%s</span>', wp_kses($crumb['title'], wpboilerplate()->kses_allowed_html('all')));
			}
		...
		echo wp_kses($html, wpboilerplate()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs()
	{
		...
		$breadcrumbs = apply_filters('wpboilerplate_get_breadcrumbs', $breadcrumbs);
 ...
 * Template Functions.
 */
if (! function_exists('wpboilerplate_breadcrumb')) {
	/**
	 ...
	 * @package wpboilerplate
	 */
	function wpboilerplate_breadcrumb($options = [])
	{
		$Crumbs = new WPBoilerplate_Breadcrumb($options);
		$Crumbs->theBreadcrumbs();
	}
}

if (! function_exists('wpboilerplate_get_breadcrumbs')) {
	/**
	 ...
	 * @return array
	 */
	function wpboilerplate_get_breadcrumbs($options = [])
	{
		$Crumbs = new WPBoilerplate_Breadcrumb($options);
 ...
 * Utility functions
 */
if (! function_exists('wpboilerplate_breadcrumb_array_insert')) {
	/**
	 ...
	 * @return array
	 */
	function wpboilerplate_breadcrumb_array_insert(array $array, $element, int $position)
	{

...
if (! function_exists('cs_switcher_option')) {
	...
	function cs_switcher_option($option = '', $default = null): bool
	{
		$options = get_option('wpboilerplate_theme_options'); // Attention: Set your unique id of the framework
...
if (! function_exists('cs_get_switcher_option')) {
	...
	function cs_get_switcher_option($option = '', $default = null): bool
	{
		$options = get_option('wpboilerplate_theme_options'); // Attention: Set your unique id of the framework
		$return_val =  (isset($options[$option])) ? $options[$option] : $default;
		$return_val = is_null($return_val) || '1' == $return_val;;
		return $return_val;
	}
}

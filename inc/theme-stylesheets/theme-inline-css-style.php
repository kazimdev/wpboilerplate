 ...
 * @since 1.0.0
 * */
global $wpboilerplate_inline_css;
$backend = wpboilerplate();
$wpboilerplate_inline_css = '';
...
$page_meta = WPBoilerplate_Group_Fields_Value::page_container('wpboilerplate', 'container_options');
...
$wpboilerplate_inline_css = ob_get_clean();
